                ...
                <div className="loginScreen__container">
                    <div className="loginScreen__main">
                        ...
                        <form action="" className="loginScreen__form">
                            ...
                            <p className="loginScreen__inputError">Please enter a valid email address or phone
                                number.</p>
                            ...
                            <p className="loginScreen__inputError">Your password must contain between 4 and 60
                                characters.</p>

                            <button type="submit" className="btn btn__login" onClick={logIn}>Sign in</button>
                            <h4>
                                <span className="loginScreen__signup__now">New to Netflix? </span>
                                <a href="/" className="loginScreen__link" onClick={register}>Sign up now</a>
                            </h4>
                        </form>
                    </div>
